...
func run(cmd *cobra.Command, args []string) {
	userSettings := kopano.NewUserSettings("philipp5")
	userSettings.Name = "Philipp5 Holzer"
	userSettings.Mail = "philipp5@dieholzers.at"
	userSettings.Password = "test"
	userSettings.SName = "Holzer5"

	conn := ldap.Connect()

	kopano.Add(conn, userSettings)
	//kopano.List(conn)
}
